...
PacketHandler.prototype.handshake_onCompleted = function (protocol, key) {
    ...
    this.socket.sendPacket(new Packet.SetBorder(this.socket.playerTracker, this.gameServer.border, this.gameServer.config.serverGamemode, "AhnigAgar " + pjson.version));
    // Send welcome message
    this.gameServer.sendChatMessage(null, this.socket.playerTracker, "AhnigAgar " + pjson.version);
